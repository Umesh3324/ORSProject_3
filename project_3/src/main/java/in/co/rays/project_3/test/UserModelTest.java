...
//		testforgetpassword();
	...
	private static void testchangepass() throws ApplicationException, RecordNotFoundException {
		...
		UserDTO dto = model.findByLogin("Dinesh2000@gmail.com");
		model.changePassword(1l , "Dinesh@123", "Dinesh@123");
...
try{
			...
			UserDTO dto = new UserDTO();
			dto.setLoginid("Umesh.prajapati297@gmail.com");
	...
	private static void testupdate() throws ApplicationException, DuplicateRecordException, ParseException {
		...
		dto.setPassword("Dinesh@123");
		dto.setLoginid("Dinesh2000@gmail.com");
		dto.setGender("male");
	...
	public static void addTest() throws Exception {
		...
		UserDTO dto= new UserDTO();
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
		dto.setFirstname("Gajendra");
		dto.setLastname("Verma");
		dto.setDob(sdf.parse("28/12/1998"));
		dto.setPassword("Jio@1234");
		dto.setLoginid("GajendraVerma@gmail.com");
		dto.setGender("Male");
		dto.setCreatedby("amdin");
		dto.setModifiedby("admin");
		dto.setRoleid(1);
